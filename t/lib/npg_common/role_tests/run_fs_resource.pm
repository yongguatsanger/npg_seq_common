...
package npg_common::role_tests::run_fs_resource;
use Moose;
use Carp;
...
with q{npg_common::roles::run::fs_resource};
...
npg_common::role_tests::run_fs_resource
...
This is a test class object for testing the role npg_common::roles::run::fs_resource, whilst you may want to use
