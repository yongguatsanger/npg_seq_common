...
SKIP: {
...

  {
    ...
    like ( $test->picard_markduplicates_command(), qr/bammarkduplicates2 I=t\/data\/scratch\/duplicates_unmarked\.bam O=\/dev\/stdout tmpfile=t\/data\/scratch\/ M=t\/data\/scratch\/out\.bam\.metrics/, 'correct picard markduplicates command');
    wipe_test_scratch($scratch);
  }
} # end skip
